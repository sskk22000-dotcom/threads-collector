...
window.__seed = async () => {
  ...
  const posts = [
    { id: 'p1', author: 'banchan', url: 'https://www.threads.com/@banchan/post/p1', authorUrl: 'https://www.threads.com/@banchan', text: '이 청국장 어디서 사요? 너무 맛있어 보여요 링크 좀요\n진짜 며칠째 생각나서 잠이 안 옴', postedAt: '2026-08-20T01:00:00.000Z', countsRaw: { views: '조회수 4.2만회', likes: '좋아요 1,203개', replies: '답글 87개', reposts: '리포스트 12개' }, images: [img('a'), img('b'), img('c')], links: [], source: '/' },
    { id: 'p2', author: 'foodie', url: 'https://www.threads.com/@foodie/post/p2', authorUrl: 'https://www.threads.com/@foodie', text: '나도 샀어! 재구매까지 했습니다 배송 얼마나 걸려요', postedAt: '2026-08-21T01:00:00.000Z', countsRaw: { views: '조회수 8,300회', likes: '좋아요 210개', replies: '답글 34개', reposts: null }, images: [img('d')], links: ['https://smartstore.naver.com/x'], source: '/' },
    ...
    { id: 'p4', author: 'curious', url: 'https://www.threads.com/@curious/post/p4', authorUrl: 'https://www.threads.com/@curious', text: '이거 뭐예요? 브랜드 알려주세요 배송 얼마나 걸리나요', postedAt: '2026-08-23T01:00:00.000Z', countsRaw: { views: '12.5K views', likes: '740', replies: '답글 21개' }, images: [img('e'), img('f')], links: [], source: '/' },
    ...
    { id: 'p7', author: 'noviews', url: 'https://www.threads.com/@noviews/post/p7', authorUrl: 'https://www.threads.com/@noviews', text: '이거 어디서 살 수 있나요? 댓글 많이 달렸네요', postedAt: '2026-08-26T01:00:00.000Z', countsRaw: { likes: '좋아요 980개', replies: '답글 64개' }, images: [img('g')], links: [], source: '/' }
  ];
